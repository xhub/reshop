...
macro(SET_C_WARNINGS _TARGETS)
   if (NOT C_COMPILER_GNU_LIKE)
      ...
      if (CMAKE_C_COMPILER_ID MATCHES "Clang") 
         ...
         foreach(_f ${clang_flags_common})
            foreach(_t ${_TARGETS})
               target_compile_options(${_T} PRIVATE "/Wno-${_f}")
            endforeach()
         endforeach()

         foreach(_f ${clang_flags_cxx})
            foreach(_t ${_TARGETS})
               target_compile_options(${_T} PRIVATE $<$<COMPILE_LANGUAGE:CXX>:"/Wno-${_f}")
            endforeach()
         endforeach()
      endif()
    ...
    # From https://github.com/nextcloud/desktop
      ...
      if (MINGW AND MINGW64_VERSION_MAJOR VERSION_LESS 13)
...
elseif(CMAKE_C_COMPILER_ID MATCHES "Intel")
  if (CMAKE_SYSTEM_NAME MATCHES "Windows")
      add_compile_options(/fp:precise /Qrestrict /Qvla /wd:589 /wd:2415 -Qdiag-disable=344,869,4137 /Qstd:c17)
   else()
