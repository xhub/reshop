...
const OpCodeArg opcodes_argv[][OP_MAXCODE] = {
   ...
   [OP_LOOPVAR_UPDATE] = {{OPARG_LIDX_ASSIGN},{OPARG_LIDX},{OPARG_IDENT_TYPE},{OPARG_IDENT_IDX}},
   [OP_PUSH_VMUINT] = {{OPARG_UINT_IDX},},
   [OP_PUSH_VMINT] = {{OPARG_INT_IDX},},
   [OP_PUSH_FALSE] = {{OPARG_NONE},},
   [OP_PUSH_TRUE] = {{OPARG_NONE},},
   [OP_POP] = {{OPARG_NONE},},
   [OP_NIL] = {{OPARG_NONE},},
   [OP_TRUE] = {{OPARG_NONE},},
   [OP_FALSE] = {{OPARG_NONE},},
   [OP_LVAR_COPYFROM_GIDX] = {{OPARG_LIDX_ASSIGN}, {OPARG_GIDX},},
   ...
   [OP_LVAR_COPYTO_LVAR] = {{OPARG_LIDX}, {OPARG_LIDX}},
   [OP_LVAR_COPYOBJLEN] = {{OPARG_LIDX}, {OPARG_IDENT_TYPE}, {OPARG_IDENT_IDX}},
   [OP_LVAR_INC] = {{OPARG_LIDX},},
   [OP_STACKTOP_COPYTO_LVAR] = {{OPARG_LIDX},},
...
const uint8_t opcodes_argc[OP_MAXCODE] = {
   ...
   [OP_TRUE] = 0,
   [OP_FALSE] = 0,
   [OP_LVAR_COPYFROM_GIDX] = 2,
   [OP_GMSSYMITER_SETFROM_LOOPVAR] = 3,
   [OP_REGENTRY_SETFROM_LOOPVAR] = 3,
   [OP_LVAR_COPYTO_LVAR] = 2,
   [OP_LVAR_COPYOBJLEN] = 3,
   [OP_LVAR_INC] = 1,
   [OP_STACKTOP_COPYTO_LVAR] = 1,
   [OP_STACKTOP_INC] = 0,
   [OP_LSET_ADD] = 2,
   [OP_LSET_RESET] = 1,
   [OP_LVEC_ADD] = 2,
...
#define DEFINE_STR() \
 ...
 DEFSTR(OP_PUSH_FALSE,"PUSH_FALSE") \
 DEFSTR(OP_PUSH_TRUE,"PUSH_TRUE") \
 DEFSTR(OP_LOOPVAR_UPDATE,"LOOPVAR_UPDATE") \
 DEFSTR(OP_POP,"POP") \
 DEFSTR(OP_NIL,"NIL") \
 DEFSTR(OP_TRUE,"TRUE") \
 ...
 DEFSTR(OP_LVAR_COPYFROM_GIDX,"LVAR_COPYFROM_GIDX") \
 DEFSTR(OP_LVAR_COPYOBJLEN,"LVAR_COPYOBJLEN") \
 DEFSTR(OP_LVAR_COPYTO_LVAR,"LVAR_COPYTO_LVAR") \
 DEFSTR(OP_LVAR_INC,"LVAR_INC") \
 DEFSTR(OP_STACKTOP_COPYTO_LVAR,"STACKTOP_COPYTO_LVAR") \
 ...
 DEFSTR(OP_EMPAPI_CALL,"CALL_API") \
