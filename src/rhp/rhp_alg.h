...
int rmdl_prepare_export(Model *mdl_src, Model *mdl_dst) NONNULL;
int rctr_compress_vars(const Container *ctr_src, Container *ctr_dst) NONNULL;
int rctr_compress_vars_x(const Container *ctr_src, Container *ctr_dst, Fops *fops) NONNULL_IDX(1,2);
