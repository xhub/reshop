...
tlsvar struct option rhp_options[] = {
   ...
   [Options_Display_Equations]     = { "display_equations",   "Display equations as png. Use '+active' for selecting actives ones, '+all' for all,  or a list (separator ',') of names",  OptString,  { .s = ""} },
